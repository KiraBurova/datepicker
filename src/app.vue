      ...
      return {          
        customPredictor:function (date) {
            if(self.selected) {
                ...
                if(dateWeekDay === selectedWeekDay && dateMonth === selectedMonth && dateDay >= selectedDay) {
                    return true;
                }
            }
        }
...
<template>
    <datepicker v-model="today" :language="ru" :monday-first="true" calendar-class="calendar" input-class="input" :highlighted="highlightedFn" :format="customFormatter" @selected="getSelectedDay"></datepicker>
</template>
